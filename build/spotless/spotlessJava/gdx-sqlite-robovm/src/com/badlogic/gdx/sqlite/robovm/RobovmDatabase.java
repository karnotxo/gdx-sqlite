...
/**
 * RoboVM database implementation (simplified, minimal error handling retained). Author: truongps
 */
public class RobovmDatabase implements Database {
  ...
  public com.badlogic.gdx.sqlite.PreparedStatement getPreparedStatement(String query)
    ...
    throw new UnsupportedOperationException(
        "Prepared statements not implemented for RoboVM backend");
  }

  @Override
  public long getLastRowId() throws SQLiteGdxException {
    throw new UnsupportedOperationException(
        "Retrieving last row id not implemented for RoboVM backend");
  }
}
